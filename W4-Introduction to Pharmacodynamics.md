...
6.  **Cytotoxic Action**(细胞毒作用): Drugs exert a **selective toxic effect** on invading pathogens (入侵的病原体 e.g., bacteria, parasites) or cancer cells, without significantly harming host cells.
