...
### Bioavailability (F)
*   **Definition**: The **rate** and **extent** to which the active drug ingredient is absorbed from its dosage form and becomes available in the systemic circulation.
*   **Absolute Bioavailability ($F_abs$)**: Fraction of an administered dose of a drug that **reaches systemic circulation unchanged** compared to the same drug given intravenously
    *   **Formula**: $F_abs = \frac{AUC_non-IV × Dose_IV}{AUC_IV × Dose_non-IV}$
*   **Relative Bioavailability ($F_rel$)**: Fraction of drug reaching systemic circulation from a non-IV formulation, compared to another non-IV formulation of the same drug.
    *   **Formula**: $F_rel = \frac{AUC_test × Dose_ref}{AUC_ref × Dose_test}$
...
*   **Basic pharmacokinetic parameters**: F(bioavailability), CL(total plasma clearance), $V_d$(volume of distribution), $t_{1/2}$(half-life)
...
*   **AUC (Area Under the Curve)**:
    ...
    *   AUC越大，药物被机体吸收越完整
![LADME process](https://github.com/HZzzzz411/Pharmacokinetics-and-Pharmacodynamics-Notes/raw/picture/image7.png)

## VIII Pharmacodynamics (药效学)
*   Effective concentration or dose needed to produce half of maximum response is **$EC_50$ or $ED_50$**
*   **Potency**: 和$ED_50$成反比
*   **Therapeutic Window or Therapeutic Index (TI)**: $TI = \frac{\text{Toxic or lethal dose at 50%}(TD_50 \text{or} LD_50)}{\text{Effective dose at 50%}(ED_50)}$
*   **Molecular mechanisms of actions**: 药物必须与特定的部位(receptor or site of action)结合才能产生反应。 药物作用靶点可以是脂质lipids、核酸nucleic acids或者蛋白质proteins。
*   **影响药物疗效的因素**
    *   Dosage form factors: properties(结构或稳定性), 剂型(胶囊或其他形式), 给药途径(口服或非口服), 剂量(低剂量或高剂量), 药物之间的相互作用(协同synergistic或拮抗antagonistic)
    *   Biological factors: 种族/物种(人类和动物), 性别(男性或女性), 年龄(儿童、老人或成年人)  生理和病理状况(健康或疾病), 生理和病理状况(健康或疾病), Genetics
